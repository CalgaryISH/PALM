...
AES_LIST_SBOX = [
    "sbox", "S_box", "SBOX", "s_box_module", "sbox_unit", "sbox_8bit", "AES_sbox", "aes_S_box" , "s_box_aes", "sbox_transformation", "sbox_substitution", "substitution_box", "aes_sub_box", "sub_box",    "sbox_logic", "sbox_lookup", "sbox_lookup_table", "sbox_lut",
     "sbox_transform", "sbox_func", "sbox_core", "sbox_proc","aes_sbox_module", "sbox_function", "sbox_processor", "sbox_transformer", "sbox_mapper", "aes_sbox_processor" ,  "sbox_data_module", "sbox_engine", "sbox_unit_core", "sbox_handler",
     "sbox_data_proc", "sbox_op", "sbox_data_op", "aes_sbox_lut", "sbox_matrix", "sbox_sub_func", "sbox_8bit_transform","aes_sbox_logic", "sbox_mapping", "sbox_table", "aes_sbox_unit", "sbox_processor_8bit", "sbox_module_8bit", "aes_sbox_transform",
    "aes_sbox_table", "sbox_byte_sub", "sbox_matrix_op" , "sbox_lookup_func", "sbox_transform_unit", "aes_sbox_lookup", "sbox_lut_module" , "sbox_data_transform", "aes_sbox_engine", "sbox_map_unit", "sbox_matrix_processor", "sbox_data_mapper",
    "aes_sbox_table_unit", "sbox_lookup_engine", "sbox_transform_core", "sbox_op_module", "sbox_mapping_proc", "aes_sbox_mapper", "sbox_byte_transformation", "sbox_matrix_logic", "sbox_func_unit", "sbox_byte_map", "aes_sbox_substitution", "sbox_core_func",
...
AES_LIST_SHIFTROWS = [
     "shift_rows", "shiftrows", "ShiftRows", "SHIFTROWS", "shift_rows_func",   "shift_rows_module", "Shift_Rows", "Shift_Rows_Module", "shiftRows", "shift_rows_block", "ShiftRowsBlock", "SHIFT_ROWS_BLOCK", "shift_rows_logic", "ShiftRowsLogic", "SHIFT_ROWS_LOGIC", "sr_func", "sr_module", "SR_block",
    "sr_logic", "sr_transform" , "ShiftRowsTransform", "SHIFTROWS_TRANSFORM" , "sr_transform_block", "shift_rows_cyclic", "ShiftRowsCyclic", "sr_cyclic","ShiftRowsMod", "shiftrows_cyclic_block", "ShiftRows_Unit", "SHIFTROWS_UNIT", "sr_cyclic_transform", "shift_rows_cycles", "ShiftRows_Cycle_Block",
    ...
    "shiftrows_block_hdl","SHIFTROWS_FSM" ,"shiftrows_logic_block", "ShiftRows_Shift_Block" , "sr_fsm_block", "sr_shift_circuit", "shiftrows_logic_hdl","ShiftRows_Shift_Module", "sr_fsm_hdl",  "shiftrows_fsm_circuit","ShiftRows_Processing_Unit", "SHIFTROWS_Processing",
